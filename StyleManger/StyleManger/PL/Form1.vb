...
Friend Class Form1
    ...
    Private Sub btnConnect_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnConnect.Click
        Try
            ...
            '    'ClsVariablesSesion.DbDomain = "192.168.0.1"
            '    'ClsVariablesSesion.Db = "curuzu"
            '    'ClsVariablesSesion.DbPass = "curuzub4s3"
            '    'ClsVariablesSesion.DbUser = "curuzu"
            '    .Save()

            'End With

            ClsVariablesSesion.DbDomain = txtHost.Text
            ClsVariablesSesion.Db = txtDB.Text
            ClsVariablesSesion.DbUser = txtUser.Text
            ClsVariablesSesion.DbPass = txtPass.Text
